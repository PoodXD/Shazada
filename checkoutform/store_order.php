...
<body>
  <div class="container">
    <div class="receipt-container">
      ...
      if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["confirm"])) {
          ...
          $sql = "INSERT INTO orders 
                  (name, email, address, city, postal_code, contact_number, total, payment_mode, ticket, created_at, item_id, item_quantity, item_subtotal)
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?, ?, ?)";

          $stmt = $conn->prepare($sql);

          $stmt->bind_param("ssssiidsisss", 
              $name, 
              $email, 
              $address,
              $city,
    ...
    <div class="receipt-footer">
      <p>Website: www.shazada.com</p>
      <p>Email: shazada@business.com</p>
      <p>Phone: 298-123-8700</p>
