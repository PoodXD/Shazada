  ...
  <body>
    <div class="container">
      ...
      <form method="POST" action="summary.php">
        ...
        <div class="form-group" id="online_payment_options" style="display: none;">
          <label>Online Payment Option:</label>
          <div class="payment-option">
            <input type="radio" id="gcash" name="online_payment_option" value="GCash">
            <label for="gcash">GCash</label>
          </div>
          <div class="payment-option">
            <input type="radio" id="paymaya" name="online_payment_option" value="PayMaya">
            <label for="paymaya">PayMaya</label>
          </div>
          <div class="payment-option">
            <input type="radio" id="paypal" name="online_payment_option" value="PayPal">
    ...
    <script>
      ...
      const onlinePaymentOptions = document.getElementById('online_payment_options');
